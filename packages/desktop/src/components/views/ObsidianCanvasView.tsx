...
export const ObsidianCanvasView: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="canvas-toolbar absolute top-3 left-4 z-20 flex items-center gap-1.5 p-1.5 rounded-2xl bg-[#14151c]/90 backdrop-blur-xl border border-white/[0.08] shadow-2xl">
        {/* Sticky Note Button */}
        <div className="relative">
          <button
            onClick={() => setIsStickerPickerOpen((v) => !v)}
            className="px-3 py-1.5 rounded-xl bg-[#f59e0b]/20 text-[#f59e0b] hover:bg-[#f59e0b]/30 text-xs font-semibold flex items-center gap-1.5 border border-[#f59e0b]/30 shadow-md"
          >
            <IconStickyNote size={15} color="#f59e0b" />
            <span>+ Стикер</span>
          </button>
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-xl bg-[#8b5cf6]/20 text-[#8b5cf6] hover:bg-[#8b5cf6]/30 text-xs font-semibold flex items-center gap-1.5 border border-[#8b5cf6]/30 shadow-md"
        >
          <Plus size={14} />
          <span>+ Карточка</span>
        </button>
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-xl bg-[#06b6d4]/20 text-[#06b6d4] hover:bg-[#06b6d4]/30 text-xs font-semibold flex items-center gap-1.5 border border-[#06b6d4]/30 shadow-md"
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1.5 border shadow-lg ${
            linkingSourceId
        ...
        <button
          ...
          className="px-2.5 py-1.5 rounded-xl bg-[#f43f5e]/15 text-[#f43f5e] hover:bg-[#f43f5e]/25 text-xs font-medium flex items-center gap-1.5 border border-[#f43f5e]/20"
