...
<p align="center">
  <a href="https://github.com/hellmorvin/NyronNetbook/releases/latest"><img src="https://img.shields.io/github/v/release/hellmorvin/NyronNetbook?style=for-the-badge&logo=github&color=7c5cff&label=LATEST_RELEASE" alt="Latest Release" /></a>
...
## 🚀 Ключевые возможности и обновления (Release Notes)

> Полная история всех релизов и изменений доступна в разделе **[GitHub Releases](https://github.com/hellmorvin/NyronNetbook/releases)**.
...
## 📥 Загрузка и Установка (Releases)

Официальные стабильные сборки для всех платформ всегда доступны в разделе **[GitHub Releases (Последняя версия)](https://github.com/hellmorvin/NyronNetbook/releases/latest)**:

| Платформа | Формат пакета | Загрузка | Описание |
| :--- | :--- | :--- | :--- |
| 🪟 **Windows 10 / 11** | `.exe` (Portable) | **[Скачать для Windows](https://github.com/hellmorvin/NyronNetbook/releases/latest)** | Автономный запуск x64 без установки |
| 📱 **Android** | `.apk` (Signed) | **[Скачать для Android (.apk)](https://github.com/hellmorvin/NyronNetbook/releases/latest)** | Мобильный релизный APK (Android 8.0 - 15+) |
| 🪟 **Windows (Zip)** | `.zip` (Archive) | **[Скачать для Windows (.zip)](https://github.com/hellmorvin/NyronNetbook/releases/latest)** | Полный архив программы в zip |
| 🐧 **Linux** | `.tar.gz` / `.AppImage` / `.deb` | **[Скачать для Linux](https://github.com/hellmorvin/NyronNetbook/releases/latest)** | Standalone x64 для Ubuntu, Debian, Fedora, Arch |
| 🍏 **macOS (Apple)** | `.dmg` / `.zip` | **[Страница релиза macOS](https://github.com/hellmorvin/NyronNetbook/releases/latest)** | Apple Silicon (M1-M4) и Intel x64 |
| 🍎 **iOS (Apple)** | `.zip` (Xcode Workspace) | **[Скачать проект iOS](https://github.com/hellmorvin/NyronNetbook/releases/latest)** | Проект для компиляции в Xcode на iPhone / iPad |
...
# ➜ Nyron-<версия>.AppImage
# ➜ nyron_<версия>_amd64.deb
```
